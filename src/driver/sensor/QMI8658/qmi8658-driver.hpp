...
//#define QMI8658_DISABLE_SDX_SCX_PURES
...
extern void qmi8658_wake_up(void);
...
extern void fifo_data_processing(unsigned char* fifo_data,unsigned short count);
#endif
