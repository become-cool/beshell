...
public:
  ...
  // PN532(uint8_t ss, SPIClass *theSPI = &SPI); // Hardware SPI
  // PN532();              // Hardware I2C
  // PN532(uint8_t reset, HardwareSerial *theSer); // Hardware UART

  PN532(JSContext * ctx, JSValue jsobj=JS_NULL) ;
  static JSValue constructor(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) ;
  static JSValue readPassiveTargetID(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) ;
